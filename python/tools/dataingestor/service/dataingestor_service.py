...
class DataIngestorService:
    ...
    def _create_source(self) -> BaseSource:
        ...
        elif source_config.type == "tushare":
            tushare_config = TushareSourceConfig(
                token=source_config.params.get("token", ""),
                api_name=source_config.params.get("api_name", ""),
                fields=source_config.params.get("fields"),
                timeout=source_config.timeout,
                params=source_config.params,
            )
            return TushareSource(tushare_config)
        else:
