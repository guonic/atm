...
class OpenTelemetryConfig:
    ...
    def __init__(self):
        ...
        self.enabled = os.getenv("NQ_OTEL_ENABLED", "false").lower() == "true"
        self.endpoint = os.getenv("NQ_OTEL_ENDPOINT", "http://localhost:4317")
        self.service_name = os.getenv("NQ_SERVICE_NAME", "nexusquant")
        self.service_version = os.getenv("NQ_SERVICE_VERSION", "0.1.0")
        self.environment = os.getenv("NQ_ENVIRONMENT", "development")
        self.trace_sampling_ratio = float(os.getenv("NQ_OTEL_TRACE_SAMPLING", "1.0"))
        self.logs_enabled = os.getenv("NQ_OTEL_LOGS_ENABLED", "true").lower() == "true"
        self.metrics_enabled = os.getenv("NQ_OTEL_METRICS_ENABLED", "true").lower() == "true"
        self.traces_enabled = os.getenv("NQ_OTEL_TRACES_ENABLED", "true").lower() == "true"
