"""
Configuration loader for NexusQuant project.
...
def _override_with_env(config_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    """
    env_mappings = {
        "NQ_DATABASE_HOST": ("database", "host"),
        "NQ_DATABASE_PORT": ("database", "port"),
        "NQ_DATABASE_USER": ("database", "user"),
        "NQ_DATABASE_PASSWORD": ("database", "password"),
        "NQ_DATABASE_NAME": ("database", "database"),
        "NQ_DATABASE_SCHEMA": ("database", "schema"),
    }
